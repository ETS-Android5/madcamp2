...
public class MyDBSearchAdapter extends RecyclerView.Adapter<MyDBSearchAdapter.Holder> {

    private Context context;
    private List<SearchDataClass.Place> list = new ArrayList<>();

    public MyDBSearchAdapter(Context context, List<SearchDataClass.Place> list) {
